...
includes the symbols exported by `LazyAlgebra` and made available by `using LazyAlgebra` but
also the non-exported public symbols of `LazyAlgebra`. This is meant for developers and
